    ...
    () => {
      ...
      setTimeout(() => {
        ...
        <div class="containerTop">
          <img class="subTitle" src="./imgs/回游計畫/小標.svg" alt="" />
        ...
        let firNumFlip = firNum.animate(
          [{ transform: "rotateX(0deg)" }, { transform: "rotateX(90deg)" }],
          { duration: 500, iterations: 1 }
        );
        let secNumFlip = secNum.animate(
          [{ transform: "rotateX(0deg)" }, { transform: "rotateX(90deg)" }],
              ...
              choise.forEach((cho) => {
                cho.addEventListener(
                  ...
                  (e) => {
                    ...
                    isProcessing = true;
                    realQueNum++;
                    console.log(cho.style.transition);
                    cho.opacity = 0.7;
                    cho.style.transform = "scale(0.7)";
                    setTimeout(() => {
                      cho.opacity = 1;
                      cho.style.transform = "scale(1)";
                    }, 300);
