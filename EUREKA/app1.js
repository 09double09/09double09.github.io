    ...
    () => {
      ...
      let chooseQue = [
        [
          ...
          "顏色錯綜複雜、充滿生命力的潑漆畫",
          "構圖平衡、繪製精美的古典主義油畫",
          "一張俯瞰工廠流水線的繪畫，色調灰暗了無生機，宛若機械",
          "寫著「留下『美』的東西吧！」，開放大家自由放置物品的大桌",
        ],
        [
          "他一直喵喵叫，到底在說什麼？",
          "牠會餓嗎，可以餵牠吃罐罐",
      ...
      setTimeout(() => {
        ...
        <div class="containerTop">
          <img class="subTitle" src="./imgs/回游計畫/小標.png" alt="" />
          <div class="progressBar">
            ...
            <img src="./imgs/齒輪.svg" alt="" class="wheel" />
          </div>
        </div>
        ...
        if (realQueNum == 8 || realQueNum == 11) {
          ...
          timer = 7300;
        } else if (realQueNum == 4) {
          timer = 5000;
        } else if (realQueNum == 9) {
          timer = 3000;
        } else if (realQueNum == 10 || realQueNum == 5) {
          timer = 3500;
        } else if (realQueNum == 7) {
          timer = 5000;
        } else {
          timer = 3000;
        }
        ...
        circle1.style.width = "3px";
        circle2.style.width = "3px";
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              wheel.style.transform = "rotate( 50deg)";
              wheel.style.left = quePercent - 5 + "%";
              setTimeout(() => {
        ...
        function changeScene() {
          ...
          if (realQueNum == 12) {
            ...
            if (realQueNum <= 11) {
              ...
              queNum = realQueNum;
              if (realQueNum == 8 || realQueNum == 11 || realQueNum == 4) {
                timer = 4000;
              } else if (realQueNum == 6 || realQueNum == 10) {
                timer = 4500;
              } else if (realQueNum == 1) {
                timer = 1800;
              } else if (realQueNum == 2) {
                timer = 1800;
              } else if (realQueNum == 3 || realQueNum == 5) {
                timer = 3000;
              } else {
                timer = 2500;
              }
